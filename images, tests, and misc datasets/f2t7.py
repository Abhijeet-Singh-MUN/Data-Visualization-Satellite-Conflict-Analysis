...
def plot_interactive_mass(data):
    """Create interactive plot with hover tooltips and consistent country markers"""
    ...
    # Key: label text, Value: y-position as percentage of y-axis height
    y_positions = {
        # Recessions
        ...
        'AI/Green Tech Investment Boom': 0.95
    }

    # Add economic periods with manual label positioning
    manual_label_positions = {
        'Suez Crisis Recession': 1958.5,   # Original midpoint 1958.1
        'AI/Green Tech Boom': 2022,  # Original midpoint 2024.71
        'Post-Pandemic Inflation': 2021.5  # Original midpoint 2023.65
}
    ...
    print("Interactive visualization created. Hover over markers to see event details.")
    plt.show()
